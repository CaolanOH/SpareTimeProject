...
Route::get('/user/events/todos/create/{id}', [UserTodoController::class, 'create'])->name('user.todos.create');
Route::get('/user/events/todos/{id}', [UserTodoController::class, 'show'])->name('user.todos.show');
Route::post('/user/events/todos/store{id}', [UserTodoController::class, 'store'])->name('user.todos.store');
Route::get('/user/events/todos/{id}/edit', [UserTodoController::class, 'edit'])->name('user.todos.edit');
Route::put('/user/events/todos/{id}', [UserTodoController::class, 'update'])->name('user.todos.update');
Route::delete('/user/events/{id}/todos/{tid}', [UserTodoController::class, 'destroy'])->name('user.todos.destroy');
